...
public class GTv2 {
	...
	public void testRunWithNegative() throws Throwable {
	    NextDate nextDate0 = new NextDate(721, 721, 721);
	    String string0 = nextDate0.run((-1036), 30, 2011);
	    assertEquals("invalid Input Date", string0);
	}
	...
	public void testCreatesNextDate14() throws Throwable {
	    ...
	    String string0 = nextDate0.run(5, 30, 1843);
	    assertEquals("5/31/1843", string0);
	}

	@Test(timeout = 4000)
	public void testCreatesNextDate13() throws Throwable {
	    NextDate nextDate0 = new NextDate(3175, 3175, 3175);
	    String string0 = nextDate0.run(3, 30, 1857);
	    assertEquals("3/31/1857", string0);
	}
	...
	public void testCreatesNextDate15() throws Throwable {
	    NextDate nextDate0 = new NextDate(721, (-811), 721);
	    String string0 = nextDate0.run(8, 31, 2002);
	    assertEquals("9/1/2002", string0);
	}
	...
	public void testCreatesNextDate9() throws Throwable {
	    NextDate nextDate0 = new NextDate(11, 11, 11);
	    String string0 = nextDate0.run(2, 29, 1856);
	    assertEquals("3/1/1856", string0);
	}
	...
	public void testRunWithPositive0() throws Throwable {
	    NextDate nextDate0 = new NextDate(1, 1, 1);
	    String string0 = nextDate0.run(1823, 1759, 1759);
	    assertEquals("invalid Input Date", string0);
	}
